...
class SaleDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sale_detail" do
    assert_difference('SaleDetail.count') do
      post sale_details_url, params: { sale_detail: { number: @sale_detail.number, price: @sale_detail.price, product_id: @sale_detail.product_id, qty: @sale_detail.qty, sale_id: @sale_detail.sale_id } }
    end
  ...
  test "should update sale_detail" do
    patch sale_detail_url(@sale_detail), params: { sale_detail: { number: @sale_detail.number, price: @sale_detail.price, product_id: @sale_detail.product_id, qty: @sale_detail.qty, sale_id: @sale_detail.sale_id } }
