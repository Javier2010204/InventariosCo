...
class RolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rol" do
    assert_difference('Rol.count') do
      post rols_url, params: { rol: { color: @rol.color, description: @rol.description, name: @rol.name } }
    end
  ...
  test "should update rol" do
    patch rol_url(@rol), params: { rol: { color: @rol.color, description: @rol.description, name: @rol.name } }
